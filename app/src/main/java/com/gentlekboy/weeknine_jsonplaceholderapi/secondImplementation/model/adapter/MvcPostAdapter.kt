...
class MvcPostAdapter(
    private var listOfPosts: MutableList<MvcPostItems>,
    private var context: Context,
    private var mvcOnclickPostItem: MvcOnclickPostItem): RecyclerView.Adapter<MvcPostAdapter.MvcPostViewHolder>() {

    inner class MvcPostViewHolder (viewItems: View): RecyclerView.ViewHolder(viewItems){
...
//            listOfPosts.clear()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MvcPostViewHolder {
        val views = LayoutInflater.from(parent.context).inflate(R.layout.mvc_posts_view_holder, parent, false)
        return MvcPostViewHolder(views)
    }
    ...
    override fun onBindViewHolder(holder: MvcPostViewHolder, position: Int) {
        ...
        holder.shareButton.setOnClickListener {
            mvcOnclickPostItem.sharePost(position, bodyOfPost)
        }

        //Set onclick listener on item view
        holder.itemView.setOnClickListener {
            mvcOnclickPostItem.navigateToCommentsActivity(position, id, userId)
        }
        ...
        holder.likeButton.setOnCheckedChangeListener { compoundButton, _ ->
            mvcOnclickPostItem.checkLikeButton(position, id, compoundButton, holder.likeCounter, holder.likeIcon, holder.likeButton)
        }
    }
